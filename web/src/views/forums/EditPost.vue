            ...
            <div class="relative">
              ...
              <div class="space-y-3">
                <div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
                  ...
                  <p class="text-sm text-slate-600 line-clamp-3 mt-2 min-h-[3.75rem]" v-if="formData.summary || formData.content" v-html="sanitizeHtml(formData.summary || formData.content)"></p>
